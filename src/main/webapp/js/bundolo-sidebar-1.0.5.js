	...
	$.get("/templates/sidebar" + "-" + version + ".html", function(template) {
	    var rendered = Mustache.render(template, {
			  "collapsibles": [
			 			    ...
			 			    { "title": "autori", "id" : "authors", "icon" : "user", "columns" : [{"column_title" : "korisničko ime", "column_name" : "author", "primary" : "true"}, {"column_title" : "opis", "column_name" : "description"}, {"column_title" : "registracija", "column_name" : "date", "column_order" : "desc"}, {"column_title" : "aktivnost", "column_name" : "activity"}] },
